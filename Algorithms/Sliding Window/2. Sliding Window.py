...
# initialize sliding window algorithm function
# it takes array as an input and size of the sliding window
def sliding_window(array, window_size):
    # initialize result (contains all of the windows generated by algorithm)
    result = []
    # go through input array
    # create a window of window size at each step using Python slicing notation
    for i in range(len(array) - window_size + 1):
        # append the window to result array
