...
- WHEN TO USE BRUTE FORCE ALGORITHM:
  - Brute Force algorithms are a good choice when the problem space is small, 
    the exact solution is required, or when other more efficient algorithms are not available.
*/
